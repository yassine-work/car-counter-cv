...
#cap.set(3,1920)
#cap.set(4,1080)
cap=cv2.VideoCapture("../videos/cars1.mp4")    #for videos
...
while True:
    ...
    results=model(imgRegion,stream=True)#stream for optimisation
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if ((currentClass=="car" or currentClass=="truck" or currentClass=="bus" or currentClass=="motorbike")
                    and conf > 0.3):
                #cvzone.putTextRect(img,f'{currentClass} {conf}',(max(0,x1),max(35,y1-35)),scale=0.6,
    ...
    for result in resultsTracker:
        ...
        cvzone.putTextRect(img, f' {int(id)}', (max(0, x1), max(35, y1 - 35)), scale=2,
